        ...
        <main className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-6 pt-28 pb-20 space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
              ...
              <div className="lg:col-span-5 flex justify-center lg:justify-end">
                <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96">
                  ...
                  <div className="w-full h-full rounded-full bg-gradient-to-b from-[#130f24]/90 to-[#0d0918]/95 border border-purple-500/40 p-4 flex flex-col justify-center items-center text-center relative overflow-hidden shadow-2xl backdrop-blur-xl group">
          ...
          <section id="about" className="scroll-mt-28 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
              <div className="md:col-span-4 bg-[#130f24]/70 border border-purple-500/20 rounded-2xl p-8 flex flex-col justify-center items-start space-y-2 hover:border-purple-500/50 transition-all shadow-xl backdrop-blur-xl group">
